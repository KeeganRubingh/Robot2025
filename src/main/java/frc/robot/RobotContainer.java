...
public class RobotContainer {
  ...
  public void configureTestButtonBindings (){
    ...
    testcontroller.b().onTrue(ReefScoreCommandFactory.getNewAutoReefAlgaeScoreSequenceCommand(drive, shoulder, elbow, elevator, wrist, coralEndEffector, algaeEndEffector));
