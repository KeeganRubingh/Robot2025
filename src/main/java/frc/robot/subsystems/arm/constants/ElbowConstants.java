...
public class ElbowConstants extends ArmJointConstants {
    public ElbowConstants() {
        ...
        this.TalonFXGains = new LoggedTunableGainsBuilder("ArmJoint"+LoggedName+"/", 60.0, 0, 0, 0, 0, 0, 0, 5.0, 8.0, 0, 0, 0);
        this.TalonFXGainsSlot1 = new LoggedTunableGainsBuilder("ArmJoint"+LoggedName+"/", 60.0, 0, 0, 0, 0, 0, 0, 5.0, 8.0, 0, 0, 0);
