...
public class StowToAlgaeStow extends SequentialCommandGroup {
    ...
    private enum ElbowPositions {
        ...
        Final(new LoggedTunableNumber("StowToAlgaeStow/elbow/FinalDegrees", -120));
    ...
    public StowToAlgaeStow(ArmJoint shoulder, ArmJoint elbow, Wrist wrist, Fingeys fingeys) {
        super(
